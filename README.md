...
## Regenerate the client using Poetry
...
*ProjectRecordsApi* | [**get_account_project_records**](docs/ProjectRecordsApi.md#get_account_project_records) | **GET** /api/projects | Get Account Project Records
...
*WorkflowsApi* | [**get_workflow_records**](docs/WorkflowsApi.md#get_workflow_records) | **GET** /api/workflows | Get Workflow Records
...
## Documentation For Models
 ...
 - [GetProjectRecordsResponse](docs/GetProjectRecordsResponse.md)
